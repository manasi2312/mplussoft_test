		...
		<div class="content">
			<div class="row">
				<h1>User Registration Form</h1>
					<form action="<?php echo e(config('app.baseURL')); ?>/registration" id="form" method="post" enctype="multipart/form-data">
					...
					<p style="text-align: center;">
                        To login your account.  <span style="color:#337ab7;"><a href="<?php echo e(config('app.baseURL')); ?>/login">Click here</span></a>
                    </p>                     						
			</div>	
		</div>	
	</div>
...
<?php /**PATH C:\xampp\htdocs\machine-test\resources\views/register.blade.php ENDPATH**/ ?>